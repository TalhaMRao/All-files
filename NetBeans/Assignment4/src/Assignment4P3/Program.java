...
public class Program
{
   ...
   public static void main(String[] args)//main
    {
        Assignment4P3.Rect rect1 = new Assignment4P3.Rect();//intializes class Rect to rect1 variable
        ...
        Assignment4P3.Rect rect2 = new Assignment4P3.Rect();//intializes class Rect to rect1 variable
        rect2.createRect();
